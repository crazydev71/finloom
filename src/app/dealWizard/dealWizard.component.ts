...
@Component({
  selector: 'app-dealWizard',
  templateUrl: './dealWizard.component.html',
  styleUrls: ['./dealWizard.style.css']
})

export class DealWizardComponent implements OnInit {
  borrowerList = [
    { value: '1', viewValue: 'Expedia Company' },
    { value: '2', viewValue: 'Home Depot Inc' },
    { value: '3', viewValue: 'PriceLine Co' },
