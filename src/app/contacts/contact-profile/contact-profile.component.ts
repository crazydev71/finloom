...
export class ContactProfileComponent implements OnInit {
  ...
  private contactFields: any[] = [
    { name: 'firstName', title: 'First Name' },
    { name: 'lastName', title: 'Last Name' },
    { name: 'primaryEmail', title: 'Email Address' },
  ...
  private isDefaultInviate = false;
  ...
  onSave() {
    let update_data = {};
    const userInfo = JSON.parse(JSON.parse(localStorage.getItem('currentUser'))['_body']);
